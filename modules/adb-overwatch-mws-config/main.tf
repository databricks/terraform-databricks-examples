...
resource "databricks_job" "overwatch" {
  ...
  new_cluster {
    ...
    spark_conf = {
      ...
      "fs.azure.account.oauth2.client.id" : data.azuread_client_config.current.client_id
      ...
      "spark.hadoop.fs.azure.account.oauth2.client.id" : data.azuread_client_config.current.client_id
