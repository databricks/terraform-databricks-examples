...
resource "azurerm_databricks_workspace" "this" {
  ...
  # Ensure the workspace depends on the subnet network security group associations being created first
  depends_on = [
...
resource "databricks_metastore_assignment" "this" {
  ...
  # Ensure the assignment depends on both the workspace and metastore being created first
