...
| [azurerm_databricks_access_connector.this](https://registry.terraform.io/providers/hashicorp/azurerm/4.31.0/docs/resources/databricks_access_connector)                                                                     | resource    |
...
| [public_subnets_cidr](https://#input_public_subnets_cidr) | CIDR block of the public subnet for cluster hosts | string | "10.20.0.128/25" | no |
| [subnet_service_endpoints](https://#input_subnet_service_endpoints) | List of service endpoints to enable on subnets | list(string) | [] | yes |
...
| [default_storage_firewall_enabled](https://#input_default_storage_firewall_enabled) | Disallow public access to default storage account | bool | false | no |
...
| [storage_account_allowed_ips](https://#input_storage_account_allowed_ips) | List of allowed IP addresses for the storage account | list(string) | [] | yes |
...
| [tags](https://#input_tags) | Tags to apply to resources for organization and billing | string | "" | yes |
