...
output "offline_packages_path" {
  description = "Path to offline packages directory"
  value       = var.offline_packages_path != null ? var.offline_packages_path : "/dbfs/init-scripts/offline-packages"
}
