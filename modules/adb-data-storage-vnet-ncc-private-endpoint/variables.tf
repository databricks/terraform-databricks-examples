...
variable "private_subnets_cidr" {
  description = "CIDR block of the private subnet for cluster containers"
  type = string
...
variable "public_subnets_cidr" {
  description = "CIDR block of the public subnet for cluster host"
  type = string
...
variable "pl_subnets_cidr" { 
  description = "CIDR block of the Private Link subnets"
  type = string
...
variable "network_security_group_rules_required" {
  description = "control whether network security group rules are required"
  type = string
  default = "AllRules"
  # Options:
  #   - "AllRules"
