...
| <a name="input_create_hub"></a> [create\_hub](#input\_create\_hub) | Whether a hub VPC exists (composer passes restricted\_egress). Gates the transit mws\_vpc\_endpoint; must be plan-time static | `bool` | `false` | no |
